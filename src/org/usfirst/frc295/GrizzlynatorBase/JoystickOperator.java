...
public class JoystickOperator extends Joystick
{
	...
	public static final short OPERATOR_BUTTON_RAMP_RISE = 5;
	public static final short OPERATOR_BUTTON_RAMP_DROP = 10;
	...
	public static final short OPERATOR_BUTTON_CORRECTCUBEPLACEMENT = 6;
	...
	JoystickButton getCorrectCubePlacement()
	{
		...
		{
		case XBOX:
			return (new JoystickButton(this, OPERATOR_BUTTON_CORRECTCUBEPLACEMENT));
